...
class Test(unittest.TestCase):
    ...
    #Test4 valida cuando es una propiedad, tiene dinero, PERO decide NO comprar la propiedad entonces continua en el juego.
    def test4(self):
        celda3 = Celda("", 1, "Propiedad", 150, 50)
    ...
    #Test5 valida cuando es una propiedad, PERO ya es el duenio, tiene dinero, decide comprar la propiedad entonces continua en el juego.
    def test5(self):
    ...
    #Test6 valida cuando es una propiedad, OTRO es el duenio, le alcanza la renta. Sigue jugando.
    def test6(self):
        celda3 = Celda("Toreto", 1, "Propiedad", 150, 50)
        persona3 = Persona("Toreto2", 160,"si")
        juego3 = Juego()
        msg = juego3.validar_movimiento(celda3,persona3)
        self.assertEquals(msg,"Usted pago renta")

    #Test7 valida cuando es una propiedad, OTRO es el duenio, NO le alcanza la renta. Pierde.
    def test7(self):
        celda3 = Celda("Toreto", 1, "Propiedad", 150, 50)
        persona3 = Persona("Toreto2", 20,"si")
        juego3 = Juego()
        msg = juego3.validar_movimiento(celda3,persona3)
